...
map.getView().fit([12545033.467068, -813622.295954, 12556448.965279, -807298.069997], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Aksesibilitas Halte Kecamatan Genteng</h2>';
        return titleElement;
    })(),
